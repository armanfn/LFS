...
fstarLin=zeros(M,N);
for j=1:tau
    [b, a, EpsilonMax]=GH_FES...
        (alpha,M,N,Train,TrainLables,fstar,sigma);
    
    [TBTemp,TRTemp,Bratio,feasib,~]=GH_evaluation...
        (alpha,NBeta,N,EpsilonMax,b,a,Train,TrainLables,gamma,NRRP,knn);
...
[SClass1,SClass2]=GH_Classification...
    (Train,TrainLables,N,Test,fstar,gamma,knn);

[~,~, ErCls1,ErCls2,ErClassification]= ...
    GH_accuracy(SClass1,SClass2,TestLables);
end